...
const REGISTERED: OperatorProfile[] = [
  ...
  {
    companyName: "Konkan King Travels",
    ...
    >
      ...
      <div>
        ...
        <h2
          ...
          style={{ fontSize: 30, color: "#0F172A", lineHeight: 1.2 }}
        >
          {page === "login" ? (
            <>
              Your fleet.
        ...
        <div className="space-y-3">
          {[
            {
              icon: "₹0",
              label: "Commission on every ticket — forever",
              green: true,
            },
            {
              icon: "✓",
              label: "Custom seat layouts for your exact bus",
              green: false,
            },
            {
              icon: "✓",
              label: "Route, fare & schedule full control",
              green: false,
            },
            {
              icon: "✓",
              label: "Revenue dashboard & live analytics",
              green: false,
            },
            ...
            <div key={i} className="flex items-center gap-3">
              <div
                className="w-6 h-6 rounded-md flex items-center justify-center shrink-0 font-mono font-bold text-xs"
                style={{
                  background: f.green ? "#F0FDF4" : "#FFF7ED",
                  color: f.green ? "#138808" : "#F97316",
                }}
              >
                {f.icon}
              </div>
      ...
      >
        ...
        <div className="text-sm" style={{ color: "#64748B", lineHeight: 1.6 }}>
          Sign up in under 2 minutes. Your portal is ready the moment you verify
          your number.
        </div>
      </div>
    </div>
        ...
        <div className="w-full max-w-sm">
          ...
          {step === "phone" ? (
            <>
              <div className="mb-8">
                <h1
                  className="font-jakarta font-black mb-1"
              ...
              <div className="space-y-4">
                ...
                {error && (
                  <div
                    className="text-sm px-3 py-2.5 rounded-xl flex items-start gap-2"
                    style={{
                      background: "#FFF7ED",
                      color: "#EA580C",
            ...
            <>
              ...
              <p
                ...
                style={{ color: "#94A3B8" }}
              >
                Enter any 6-digit code for the demo
              </p>
            </>
          )}
        </div>
          ...
          {step === "form" ? (
            <>
              <div className="mb-7">
                ...
                <p className="text-sm" style={{ color: "#64748B" }}>
                  Set up your operator portal in 2 minutes.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label
                    ...
                    style={{ color: "#94A3B8" }}
                  >
                    Email <span style={{ color: "#CBD5E1" }}>(optional)</span>
                  </label>
                  <input
                    className="op-input w-full"
                    style={{
            ...
            <>
              ...
              <p
                className="text-sm mb-8 font-jakarta font-semibold"
                style={{ color: "#0F172A" }}
              >
                {companyName}
              </p>

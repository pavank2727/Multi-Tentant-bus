...
function StatCard({
  ...
  return (
    <div className="card rounded-xl p-5">
      ...
      <div
        className="font-jakarta font-black text-3xl mb-1"
  ...
  return (
    <div className="p-6 space-y-5 fade-in" style={{ background: "#F8FAFC" }}>
      ...
      <div className="grid grid-cols-4 gap-4">
        <StatCard
          label="Total Buses"
          value={String(operator.totalBuses)}
          sub={`${running} currently running`}
        />
        <StatCard
          label="Active Routes"
          value={String(operator.activeRoutes)}
          sub="Across 4 branches"
          accent
        />
        <StatCard
          label="Avg Occupancy"
          value={`${avgOcc}%`}
          sub="This week across all routes"
        />
        <StatCard
            ...
            {schedules.map((s) => {
              ...
              return (
                <tr key={s.id}>
                  ...
                  <td>
                    <span className="font-mono font-medium">{s.departure}</span>
                  </td>
                  <td>{s.driver}</td>
                  <td>
                  ...
                  <td>
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{ background: "#F1F5F9", minWidth: 60 }}
                      >
                        <div
                          className="h-1.5 rounded-full"
                          style={{

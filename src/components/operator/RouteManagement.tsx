      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          { label: "Total Routes", value: routes.length, color: "#0F172A" },
          {
            ...
            value: routes.reduce((a, r) => a + r.activeSchedules, 0),
            color: "#F97316",
          },
          {
            label: "Avg Occupancy",
            value: `${Math.round(routes.reduce((a, r) => a + r.avgOccupancy, 0) / routes.length)}%`,
            color: "#16A34A",
          },
          {
            label: "Total Distance",
            value: `${routes.reduce((a, r) => a + r.distance, 0)} km`,
            color: "#2563EB",
          },
        ].map((s, i) => (
        ...
        <div className="card rounded-xl p-5" style={{ borderColor: "#FED7AA" }}>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-3">
              ...
              <input
                className="op-input w-full"
                placeholder="Wakad, Pimpri, Shivajinagar, Swargate"
              />
            </div>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-3">
              <span className="badge badge-blue">
                {route.activeSchedules} Schedules
              </span>
              <span
                className={`badge ${
                  route.avgOccupancy >= 85
                    ? "badge-red"
                    : route.avgOccupancy >= 70
                      ? "badge-yellow"
                      : "badge-green"
                }`}
              >
            ...
            >
              <div
                ...
                style={{
                  width: `${route.avgOccupancy}%`,
                  background: route.avgOccupancy >= 85 ? "#F97316" : "#16A34A",
                }}
              />
            </div>
            ...
            {selected === i && (
              ...
              >
                {[
                  {
                    title: "Via Points",
                    items: route.viaPoints,
                    style: "badge-gray",
                  },
                  {
                    title: "Boarding Points",
                    items: route.boardingPoints,
                    style: "badge-red",
                  },
                  {
                    title: "Dropping Points",
                    items: route.droppingPoints,
                    style: "badge-gray",
                  },
                ].map((section) => (
                  <div key={section.title}>
                    ...
                    <div className="flex gap-1.5 flex-wrap">
                      {section.items.map((v) => (
                        <span key={v} className={`badge ${section.style}`}>
                          {v}
                        </span>
                      ))}
                    </div>

...
export const routes = [
  {
    id: "RT-001",
    from: "Mumbai (Dadar)",
    to: "Pune (Shivajinagar)",
    distance: 155,
    duration: "3h 30m",
    boardingPoints: ["Dadar TT", "Sion", "Vashi"],
    droppingPoints: ["Wakad", "Pimpri", "Shivajinagar", "Swargate"],
    viaPoints: ["Khopoli", "Khalapur"],
    activeSchedules: 12,
    avgOccupancy: 84,
  },
  {
    ...
    distance: 212,
    duration: "4h 15m",
    boardingPoints: ["Swargate", "Hadapsar", "Shirur"],
    droppingPoints: ["Sinnar", "Nashik CBS", "Nashik Road"],
    viaPoints: ["Sangamner", "Kopargaon"],
    activeSchedules: 6,
    avgOccupancy: 71,
  },
  {
    ...
    distance: 392,
    duration: "6h 45m",
    boardingPoints: ["Borivali", "Andheri", "Thane"],
    droppingPoints: ["Jalna Road", "Aurangabad CBS", "Cidco"],
    viaPoints: ["Igatpuri", "Manmad", "Aurangabad"],
    activeSchedules: 4,
    avgOccupancy: 68,
  },
  {
    ...
    distance: 185,
    duration: "4h 00m",
    boardingPoints: ["Nashik CBS", "Dindori Naka", "Ghoti"],
    droppingPoints: ["Thane", "Dadar", "Borivali"],
    viaPoints: ["Igatpuri", "Shahapur"],
    activeSchedules: 8,
    avgOccupancy: 91,
  },
]
...
export const trips = [
  {
    ...
    bus: "MH-12-AB-4521",
    seats: ["L3", "L4"],
    passengers: ["Priya Sharma", "Rohit Sharma"],
    fare: 1300,
    status: "upcoming",
  ...
  },
  {
    ...
    bus: "MH-12-IJ-5566",
    seats: ["A12", "A13"],
    passengers: ["Priya Sharma", "Anita Sharma"],
    fare: 1160,
    status: "cancelled",
    boardingPoint: "Andheri",
    droppingPoint: "Aurangabad CBS",
  },
]
...
export const drivers = [
  {
    ...
    currentBus: "MH-12-AB-4521",
  },
  {
    id: "DRV-002",
    name: "Suresh Desai",
    license: "MH12 20160038124",
    ...
    currentBus: "MH-12-CD-7803",
  },
  {
    id: "DRV-003",
    name: "Mahesh Jadhav",
    license: "MH12 20190051234",
    licenseExpiry: "2029-09-10",
    experience: "7 yrs",
    trips: 892,
    rating: 4.4,
    status: "on-duty",
    contact: "+91 97654 32109",
    currentBus: "MH-12-EF-1192",
  },
  {
    id: "DRV-004",
    name: "Anand Kulkarni",
    license: "MH12 20150029876",
    ...
    currentBus: "MH-12-GH-3374",
  },
  {
    id: "DRV-005",
    name: "Vijay Pawar",
    license: "MH12 20200067891",
  ...
  for (let r = 0; r < 13; r++) {
    layout.push([
      ...
      },
      {
        id: `${labels[r]}2`,
        label: `${labels[r]}2`,
        status: statuses[Math.floor(r * 1.3) % 13],
        type: "seater",
      },
      null,
      {
        id: `${labels[r]}3`,
        label: `${labels[r]}3`,
        status: statuses[(r + 3) % 13],
        type: "seater",
      },
      {
        id: `${labels[r]}4`,
        label: `${labels[r]}4`,
        status: statuses[(r + 5) % 13],
        type: "seater",
      },
    ])
  }
